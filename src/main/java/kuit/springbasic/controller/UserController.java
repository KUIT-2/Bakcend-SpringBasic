...
public class UserController {
    ...
    public String createUserV1(@RequestParam String userId,
        ...
        userDao.insert(signUpUser);
        log.info("UserController.createUserV1 Success");
        return "redirect:/user/list";
    }
    @PostMapping("/signup")
    public String createUserV2(@ModelAttribute User signUpUser) throws SQLException{
    ...
    @PostMapping("/update")
    public String updateUserV2(@ModelAttribute User user) throws SQLException{
        // 개인정보 수정
        userDao.update(user);
