                    ...
                    <c:if test="${not empty sessionScope.user}">
                        <li>
                            <a class="link-modify-article"
                               href="/v3/v2/qna/updateForm?questionId=${question.questionId}">수정</a>
                        </li>
                    </c:if>
                    <li>
                        <a class="link-modify-article" href="/v3/v2/qna/delete?questionId=${question.questionId}">삭제</a>
                    </li>
                    <li>
                        ...
                        <article class="article">
                            ...
                            <div class="article-util">
                                <ul class="article-util-list">
                                    <li>
                                        <a class="link-modify-article"
                                           href="/v3/v2/api/qna/updateAnswer?answerId=${each.answerId}">수정</a>
                                    </li>
                                    <li>
                                        <form class="form-delete" action="/v3/v2/api/qna/deleteAnswer" method="POST">
...
<script type="text/template" id="answerTemplate">
    <article class="article">
        ...
        <div class="article-util">
            <ul class="article-util-list">
                <li>
                    <a class="link-modify-article" href="/v3/v2/api/qna/updateAnswer/{3}">수정</a>
                </li>
                <li>
                    <form class="form-delete" action="/v3/v2/api/qna/deleteAnswer" method="POST">
